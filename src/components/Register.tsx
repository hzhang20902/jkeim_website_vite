...
const registerSubmit = (data: { parentName: string; studentName: string; pronoun: string; email: string; phone: string; city: string; state: string; zipcode: string; message: string; }) => {
